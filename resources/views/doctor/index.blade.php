@extends('layouts.adminlte', [
    'title' => "Doctors",
    'header' => "Lista de Doutores",
    'addButton' => [
        'title' => "Adicionar Médico(a)",
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    @foreach($doctors as $doctor)
                        <tr>
                            ...
                            <td>{{$doctor->phone}}</td>
                            <td>{{$doctor->CRM}}</td>
                            <td>{{$doctor->working_period}}</td>
                            <td>{{\App\Models\Specialty::find($doctor->specialty_id)->name}}</td>
                            <td>
                                <a class="btn btn-primary" href="{{route('doctor.show', $doctor->id)}}">
                                    <i class="fa fa-eye"></i>
                                </a>

                                <a class="btn btn-warning" href="{{route('doctor.edit', $doctor->id)}}">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <button onclick="fillModal('doctor/{{$doctor->id}}')" class="btn btn-danger" data-bs-toggle="modal" data-toggle="modal" data-target="#destroyModal">
